...
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE =
    DEFAULT_BLOCK_MAX_SIZE / 5;
/** Default for -blockmaxweight, which controls the range of block weights the
 * mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_WEIGHT = 40000000;
 ...
 * stack elements These limits are adequate for multi-signature up to n-of-100
 * using OP_CHECKSIG, OP_ADD, and OP_EQUAL,
 */
